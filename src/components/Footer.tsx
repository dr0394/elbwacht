        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          <div>
            <div className="flex items-center space-x-3 mb-6">
              <div className="p-2 bg-gradient-to-br from-blue-700 to-blue-800 border-2 border-blue-700">
          ...
          <div>
            ...
            <ul className="space-y-3">
              {['Objektschutz', 'Eventschutz', 'Revierdienst', 'Empfangsdienste', 'Baustellensicherung', 'Mietnomaden-Schutz'].map((item) => (
                <li key={item}>
                  <a href="#leistungen" className="hover:text-blue-700 transition-colors font-medium text-gray-700">
                    {item}
                  </a>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-3">
              {[
                ...
                <li key={item.label}>
                  <a href={item.href} className="hover:text-blue-700 transition-colors font-medium text-gray-700">
                    {item.label}
                  </a>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start space-x-3">
                <Phone className="h-5 w-5 text-blue-700 flex-shrink-0 mt-0.5" />
                <div className="font-medium text-gray-700">
                  <a href="tel:+4940253302940" className="hover:text-blue-700 transition-colors block">
                    +49 40 / 25330294
                  </a>
                  <a href="tel:+491638467694" className="hover:text-blue-700 transition-colors block text-sm mt-1">
                    +49 163 / 8467694
                  </a>
                </div>
              </li>
              <li className="flex items-start space-x-3">
                ...
                <a href="mailto:info@elbwacht.de" className="hover:text-blue-700 transition-colors font-medium text-gray-700">
                  info@elbwacht.de
                </a>
              </li>
              <li className="flex items-start space-x-3">
        ...
        <div className="pt-8 border-t border-gray-200">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex gap-6">
              <Link to="/impressum" className="hover:text-blue-700 transition-colors text-sm font-medium text-gray-700">
                Impressum
              </Link>
              <Link to="/datenschutz" className="hover:text-blue-700 transition-colors text-sm font-medium text-gray-700">
                Datenschutz
              </Link>
            </div>
          </div>
