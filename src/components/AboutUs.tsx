...
export default function AboutUs() {
  return (
    <section id="ueber-uns" className="relative py-24 bg-gradient-to-b from-gray-50 via-white to-gray-100">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-16 items-center mb-20">
          <div>
            <div className="inline-block mb-6 px-6 py-2 border-2 border-blue-700 bg-blue-100/50 backdrop-blur-sm rounded-full">
              <span className="text-blue-700 font-black text-sm tracking-widest uppercase">Über uns</span>
            </div>
            <h2 className="text-4xl lg:text-5xl font-black mb-6 tracking-tight text-gray-900">
              Stärke durch Präsenz
            </h2>
            <p className="text-xl mb-8 leading-relaxed font-medium text-gray-700">
              Bei Elbwacht arbeiten wir für Unternehmen, Immobilienbesitzer und Veranstalter, die Sicherheit ernst nehmen.
            </p>
            <p className="text-lg mb-8 leading-relaxed font-medium text-gray-700">
