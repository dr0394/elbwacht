      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-20">
          <div className="inline-block mb-6 px-6 py-2 border-2 border-red-600 bg-red-950/20 backdrop-blur-sm rounded-full">
            <span className="text-red-500 font-black text-sm tracking-widest uppercase">Kundenmeinungen</span>
          </div>
            ...
            <div key={index} className="group relative">
              ...
              <div className="relative h-full bg-gradient-to-br from-gray-900/90 to-black/90 backdrop-blur-sm border border-gray-800 group-hover:border-red-600/50 rounded-lg p-8 transition-all">
                <div className="flex justify-between items-start mb-6">
                  <Quote className="h-10 w-10 text-red-600/40" strokeWidth={2} />
        ...
        <div className="mt-16 text-center">
          <div className="inline-flex items-center gap-2 bg-black/80 backdrop-blur-sm px-8 py-6 rounded-full border border-white/10">
            ...
            <span className="text-gray-400 font-medium">von über 200 Bewertungen</span>
          </div>
        </div>
      </div>
    </section>
