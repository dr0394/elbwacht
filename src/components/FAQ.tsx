      ...
      <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-20">
          <div className="inline-block mb-6 px-6 py-2 border-2 border-red-600 bg-red-950/20 backdrop-blur-sm rounded-full">
            <span className="text-red-500 font-black text-sm tracking-widest uppercase">Häufige Fragen</span>
          </div>
        ...
        <div className="space-y-4">
          {faqs.map((faq, index) => (
            <div key={index} className="group relative">
              <div className="absolute -inset-1 bg-red-600/10 blur-xl opacity-0 group-hover:opacity-100 transition-all rounded-lg"></div>
              <div className="relative bg-gradient-to-br from-gray-900/90 to-black/90 backdrop-blur-sm border border-gray-800 group-hover:border-red-600/50 rounded-lg transition-all overflow-hidden">
                <button
                  onClick={() => setOpenIndex(openIndex === index ? null : index)}
                  className="w-full px-8 py-6 flex items-center justify-between text-left"
                >
                  <div className="flex items-center gap-4 flex-1">
                    <div className="flex-shrink-0 p-2 bg-red-600/20 border-2 border-red-600 rounded-lg">
                      <HelpCircle className="h-5 w-5 text-red-500" strokeWidth={2.5} />
                    </div>
                  ...
                  <ChevronDown
                    className={`h-6 w-6 text-red-500 transition-transform flex-shrink-0 ml-4 ${
                ...
                {openIndex === index && (
                  <div className="px-8 pb-6">
                    <div className="pl-12 pt-2 border-t border-gray-800">
        ...
        <div className="mt-16 text-center">
          <div className="inline-block bg-gradient-to-br from-gray-900/90 to-black/90 backdrop-blur-sm border border-gray-800 rounded-lg p-8">
            ...
            <a
              ...
              className="inline-block bg-red-600 hover:bg-red-700 text-white px-8 py-4 rounded-full font-bold transition-all transform hover:scale-105"
            >
               +49 40 25330294
            </a>
          </div>
