...
export default function HeroSection({ onOpenForm }: HeroSectionProps) {
  return (
    <section id="hero" className="relative pt-20 overflow-hidden min-h-screen flex items-center bg-gradient-to-br from-white via-gray-50 to-gray-100 text-gray-900 w-full">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-24 w-full">
        <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-2 mt-8 sm:mt-12 w-full">
            <div className="grid md:grid-cols-3 gap-4 sm:gap-6">
              {[
                ...
                <div
                  key={index}
                  className="backdrop-blur-sm border-2 p-4 sm:p-6 rounded-lg relative overflow-hidden group hover:scale-105 transition-all duration-300 w-full"
                  style={{
                ...
                >
                  ...
                  <div className="relative">
                    <div className="flex items-start space-x-2 sm:space-x-3 mb-2 sm:mb-3">
                      ...
                      />
                      <h3 className="font-black text-base sm:text-lg leading-tight text-gray-900 break-words">{item.title}</h3>
                    </div>
                    <p className="text-xs sm:text-sm font-medium leading-relaxed text-gray-700 pl-4 sm:pl-5 break-words">{item.description}</p>
                  </div>
                </div>
              ))}
            </div>
