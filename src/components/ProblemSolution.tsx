      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-20 border-b border-gray-200 pb-12">
          <div className="inline-block mb-6 px-6 py-2 border-2 border-blue-700 bg-blue-50 backdrop-blur-sm rounded-full">
            <span className="text-blue-700 font-black text-sm tracking-widest uppercase">Mission Statement</span>
          </div>
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 mb-12">
          <div className="relative group">
            ...
            <div className="relative bg-gradient-to-br from-white to-gray-50 backdrop-blur-sm p-8 border-l-4 border-blue-700 border border-gray-200 rounded-lg">
              <div className="flex items-start justify-between mb-6">
                <div className="flex items-center space-x-4">
                  <div className="p-3 bg-blue-700/20 border-2 border-blue-700 rounded-lg">
                    <AlertTriangle className="h-8 w-8 text-blue-700" strokeWidth={2.5} />
                  </div>
                  <h3 className="text-2xl font-black text-gray-900 uppercase tracking-tight">Die Bedrohung</h3>
                </div>
                <div className="px-4 py-2 bg-blue-700 border-2 border-blue-700 rounded-full">
                ...
                {[
                  ...
                  <li key={index} className="flex items-start space-x-4 group/item">
                    <div className="flex-shrink-0 mt-1">
                      <div className="w-6 h-6 border-2 border-blue-700 rounded-sm flex items-center justify-center">
                        <X className="h-4 w-4 text-blue-700" strokeWidth={3} />
                      </div>
                    </div>
          ...
          <div className="relative group">
            <div className="absolute -inset-1 bg-blue-700/10 blur-2xl group-hover:bg-blue-700/20 transition-all rounded-lg"></div>
            <div className="relative bg-gradient-to-br from-blue-50 to-gray-50 backdrop-blur-sm p-8 border-l-4 border-blue-700 border border-blue-700/30 rounded-lg">
              <div className="flex items-start justify-between mb-6">
                <div className="flex items-center space-x-4">
                  <div className="p-3 bg-blue-700/20 border-2 border-blue-700 rounded-lg">
                    <CheckCircle className="h-8 w-8 text-blue-700" strokeWidth={2.5} />
                  </div>
              ...
              <ul className="space-y-4">
                {[
                  ...
                  <li key={index} className="flex items-start space-x-4 group/item">
                    <div className="flex-shrink-0 mt-1">
                      <div className="w-6 h-6 bg-blue-700 border-2 border-blue-700 rounded-sm flex items-center justify-center group-hover/item:scale-110 transition-transform">
